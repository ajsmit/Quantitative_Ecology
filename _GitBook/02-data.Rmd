...
```{r species_table, echo = FALSE, fig.margin = TRUE, fig.cap = "The table (or spreadsheet) view of the species data. Note the species codes appearing as column headers; numbered from 1 through to 58 (row 58 is at the bottom of the table, so you'd have to scroll down to see it) at the bottom of the table are each of the samples --- in this case, there is one sample per station."}
knitr::include_graphics("figures/species_table.png")
```

```{r species_tibble, echo = FALSE, fig.margin = TRUE, fig.cap = "This is a tibble printout of the same species data we saw in Figure 2.1."}
knitr::include_graphics("figures/species_tibble.png")
```

```{r environment_table, echo = FALSE, fig.margin = TRUE, fig.cap = "The table view of the environmental data. The names of the environmental variables appear as column headers, and numbered from 1 through to 58 at the bottom of the table are each of the samples --- the samples are defined as per Figure 2.1."}
knitr::include_graphics("figures/env_table.png")
```

```{r environment_tibble, echo = FALSE, fig.margin = TRUE, fig.cap = "A tibble printout of the same environmental data we saw in Figure 2.3."}
knitr::include_graphics("figures/env_tibble.png")
```
